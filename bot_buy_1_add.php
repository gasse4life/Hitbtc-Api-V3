  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Bot #1 Create order</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
...
$date = Date("Y-m-d H:i:s");
 /////
                //insert setting  in database - bot_buy_1 table
                $nextin = $_POST['nextstep']-($_POST['nextstep']*$_POST['percent']/100);
                $nextins = number_format($nextin,$tick);
                $sqlinsert = "INSERT IGNORE INTO bot_buy_1(seq, symbol, nextstep, aps, percent, pnl, active, cronmin, deal) 
                VALUES ('',
                        '".$inSymbol."',  
                        '".$nextins."',
                        '".$inQty."',
 ...
 echo $inSymbol . " successfully added to bot #1.";
...
if ($quote=='USD'){ 
/////////*///////*/**/*/*/*/* */   else if per base/quote  see bot_buy_1
...
/////////*///////*/**/*/*/*/* */
 ...
 ?>
            ...
            <tr>
            <td>This Bot buy selected amount every selected %. <br></td>
            </tr> 
            <tr>
            <td> 
                                    ...
                                    Buy every <input type='text' name='percent' size='11' value='2'> %<br>
                                    P&L Take Profit : <input type='text' name='pnl' size='11' value='5'> %<br>
                                    Stop at : <input type='text' name='stoplimit' size='11' value='<?php echo number_format($ask10,$tick)?>'> <br>
                                       <br>
