  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Orders Status BGL</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
   ...
   if (!empty($result->error)) { 
                                                          ...
                                                          foreach($result as $item) {  
                                                            ...
                                                            $errorbbt = "INSERT IGNORE INTO error(seq, error) 
                                                              VALUES ('', 'ERROR: Could not able to execute. pushordermanual_bgl.php <br>".$symbol."<br>".$item->code."<br>".$item->message."<br>')";                    
    ...
    /////
   //insert order 
       $sqlinsert = "INSERT INTO bgl_getorders(id, howto, orderId, clientOrderId, ostatus, astatus, symbol, side, atype, timeInForce, quantity, step1, loss, cumQuantity, price, stop_price, timestamp, qtyinc, autosell, percent, base, quote) 
       VALUES ('0', 
               'manual',  
               '".$result->id."', 
