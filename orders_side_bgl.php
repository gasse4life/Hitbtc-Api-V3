      ...
      <div class="container-fluid">
        ...
        <!-- Main row -->
                                  ...
                                  <?php   
                                    ...
                                    $upautosell ="UPDATE `bgl_getorders` SET `autosell` = '".$_POST['autos']."' WHERE `seq` = '".$_POST['seq']."'";
...
$per_page = 50;
$sqlcount = "select count(*) as total_records from bgl_getorders";
...
if ($_GET['Side']=='buy') {
  $sql = "SELECT * FROM `bgl_getorders` WHERE side = '$getSide' AND ostatus = '$getStatus' AND astatus = 'filled' ORDER BY `seq` DESC LIMIT $offset, $per_page";
} 
if ($_GET['Side']=='new') {
  $sql = "SELECT * FROM `bgl_getorders` WHERE astatus = 'new' ORDER BY `seq` DESC LIMIT $offset, $per_page";
} 
if ($_GET['Side']=='partiallyFilled') {
  $sql = "SELECT * FROM `bgl_getorders` WHERE astatus = 'partiallyFilled' ORDER BY `seq` DESC LIMIT $offset, $per_page";
} 
if ($_GET['Side']=='canceled') {
   $sql = "SELECT * FROM `bgl_getorders` WHERE astatus = 'canceled' ORDER BY `seq` DESC LIMIT $offset, $per_page";
}  
if ($_GET['Side']=='lock') {
   $sql = "SELECT * FROM `bgl_getorders` WHERE autosell = '3' AND ostatus = '1' ORDER BY `seq` DESC LIMIT $offset, $per_page";
} 
  ...
  $aactive = "SELECT * FROM `bgl_getorders` WHERE ostatus = '1'";
...
if(isset($_POST['btn1'])){
  ...
  $setallautosell = "UPDATE `bgl_getorders` SET percent = '".$_POST['percent']."', autosell='1' WHERE side='buy' AND ostatus='1' AND autosell!='3'";
...
include "module/ColorByProfit.php"; 
                ...
                echo "<td>";
                                          if (!empty($row['soldby'])) {
                                            ...
                                            $sqlsell = "SELECT * FROM bgl_getorders where clientOrderId='" . $row['soldby'] . "'";
